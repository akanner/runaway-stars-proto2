...
CREATE TABLE `image` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=295 DEFAULT CHARSET=big5;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2017-03-27 22:34:58
