...
class AppParameterRepository extends EntityRepository
{
	...
	{
		$answerPoints = $this->findOneByKey("POINTS_CORRECT_RESPONSE")->getValue();
		return intval($answerPoints);
	}

	public function getPointsForIncorrectAnswer()
	{
		$answerPoints = $this->findOneByKey("POINTS_INCORRECT_RESPONSE")->getValue();
		return intval($answerPoints);
	}
